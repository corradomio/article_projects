...
class GOLEM(BaseLearner):
    ...
    def __init__(self, B_init=None,
        ...
        self.logging = logging.getLogger('castle.algorithm.golem')
    ...
    def _golem(self, X):
        ...
        self.logging .info("Started training for {} iterations.".format(int(self.num_iter)))
        for i in range(0, int(self.num_iter) + 1):
            ...
            if self.checkpoint_iter is not None and i % self.checkpoint_iter == 0:
                self.logging .info("[Iter {}] score={:.3f}, likelihood={:.3f}, h={:.1e}".format( \
