...
TARGET = 'import_kg'
USED_LIBRARY = "skt"
RESULT_FILE = "wape_skt_arima.csv"
...
def compare_models(g, Xtr, ytr, Xte, yte):
    ...
    # AutoARIMA
    use_model(g, "auto_arima", sktime.forecasting.arima.AutoARIMA(), Xtr_scaled, ytr_scaled, Xte_scaled, yte_scaled, fh, USED_LIBRARY, RESULT_FILE)
